...
public class MichealMedia extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_micheal_media);
        playBtn = findViewById(R.id.playBtn);
        elapsedTimeLabel = findViewById(R.id.elapsedTimeLabel);
        remainingTimeLabel = findViewById(R.id.remainingTimeLabel);

        // Media Player
        mp = MediaPlayer.create(this, R.raw.stmichael20);
        mp.setLooping(true);
        mp.seekTo(0);
    ...
    // Zoom out function, going back to main floor [main activity]
    public void LateGothicHall (View v) {
        Intent i = new Intent(this,LateGothicHall.class );
        startActivity(i);
    }
